<x-master>
      <main class="h-full overflow-y-auto">
        ...
        @endif
            ...
            >
              Ajouter un nouveau délai pour le dossier N° : {{$dossier->num}}
            </h2>
            ...
            <form action="/dossiers/{{$dossier->id}}/delais" method="POST">
              @csrf
                    @error('date')
...
<!-- fin date picker-->
              ...
              <label class="block text-sm mt-4">
                <span class="text-gray-700 dark:text-gray-400">Raison du délai</span>
                <textarea
