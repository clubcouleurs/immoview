<x-layout>
  ...
  <div class="alert-toast fixed bottom-0 right-0 m-8 w-5/6 md:w-full max-w-sm">
    ...
    <label class="close cursor-pointer flex items-start justify-between w-full p-2 bg-green-500 h-10 rounded-lg shadow-lg text-white font-bold" title="close" for="footertoast">
  ...
  <div class="alert-toast fixed bottom-0 right-0 m-8 w-5/6 md:w-full max-w-sm">
    ...
    <label class="close cursor-pointer flex items-start justify-between w-full p-2 bg-red-500 h-10 rounded-lg shadow-lg text-white font-bold" title="close" for="footertoast">
            ...
            <div class="flex justify-center flex-1 lg:mr-32">
              ...
              >
                <div class="absolute inset-y-0 flex items-center pl-2">
                  ...
                  <p class="text-2xl text-gray-700 font-thin ml-2"> Hello {{Auth::user()->name}}</p>
