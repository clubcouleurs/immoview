          ...
          <li class="relative px-6 py-3">
              ...
              >
                <span class="inline-flex items-center">
                  ...
                  <span class="ml-4">Prospection</span>
                </span>
                <svg
                  class="w-4 h-4"
                  aria-hidden="true"
              ...
              <template x-if="isVisitesMenuOpen">
                <ul
                ...
                @can('editer visites')
                  ...
                  >
                    <a class="w-full" href="/visites/create">Ajouter une visite</a>
                  </li>
                @endcan
                @can('voir visites')
                  <li
                    class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                  >
                    <a class="w-full" href="/visites">Visites</a>
                  </li>
                @endcan
                @can('voir clients')
                  <li
                    class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                  >
                    <a class="w-full" href="/clients?activer=0">Prospects</a>
                  </li>
                @endcan
            ...
            @canany(['voir dossiers appartements',
                ...
                @can('voir appartements')      
                  ...
                  <li
                    class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                  >
                    <a class="w-full" href="/appartements">Appartements</a>
                  </li>
                @endcan
                </ul>
              </template>
...
<li class="relative px-6 py-3">
              ...
              <template x-if="isClientsMenuOpen">
                ...
                @can('editer clients')
                  <li
                    class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                  >
                    <a class="w-full" href="/clients/create">Ajouter un Client</a>
                  </li>
                  @endcan
                  @can('voir clients')
                  <li
                    class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                  >
                    <a class="w-full" href="/clients">Clients</a>
                  </li>
                  @endcan
          ...
          @can('voir paiements')
            <li class="relative px-6 py-3">
              ...
              >
                <span class="inline-flex items-center">
                  ...
                  <span class="ml-4">Paiements</span>
                </span>
                <svg
                  class="w-4 h-4"
                  aria-hidden="true"
              ...
              <template x-if="isPaiementsMenuOpen">
                <ul
                  x-transition:enter="transition-all ease-in-out duration-300"
                  x-transition:enter-start="opacity-25 max-h-0"
                  x-transition:enter-end="opacity-100 max-h-xl"
            ...
            @endcan
            @canany(['voir tranches','voir immeubles','voir voies'])
            <li class="relative px-6 py-3">
              <button
                class="inline-flex items-center justify-between w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                @click="toggleAmenagementMenu"
                aria-haspopup="true"
              >
                <span class="inline-flex items-center">
                  <svg
                  ...
                  <span class="ml-4">Aménagement</span>
                </span>
                <svg
                  class="w-4 h-4"
                  aria-hidden="true"
              ...
              <template x-if="isAmenagementMenuOpen">
                <ul
                  x-transition:enter="transition-all ease-in-out duration-300"
                  x-transition:enter-start="opacity-25 max-h-0"
                  x-transition:enter-end="opacity-100 max-h-xl"
                ...
                @can('voir tranches')
                  ...
                  <li
                    class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                  >
                    <a class="w-full" href="/tranches">Tranches</a>
                  </li>
                  @endcan
                @can('voir voies')
              ...
              <template x-if="isAccesMenuOpen">
                ...
                @can('voir utilisateurs')
                  ...
                  <li
                    class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                  >
                    <a class="w-full" href="/users">Utilisateurs</a>
                  </li>
                  @endcan
                @can('voir roles')
