...
<!-- fin date picker-->
              ...
              <label class="block mt-4 text-sm">
                ...
                @foreach ($villes as $ville)
                  <option value="{{ $ville }}"
                    @if( $projet->ville !== null )
                        @if($projet->ville == $ville )
                          selected
                        @endif
                    @endif
                    >
                ...
                <div class="mt-2">
                  ...
                  >
                    <input
                      ...
                      @foreach ($types_constructibles_projet as $t)
                        @if($t == getSingular($type))
                          checked
                        @endif
                      @endforeach
    ...
    function app() {
      return {
        ...
        getDateValue(date) {
          ...
          this.datepickerValue = '@isset($projet->date){{ $projet->date }}@else' + 
            an + '-' + mois + '-' + jour; 
          + '@endisset';       
