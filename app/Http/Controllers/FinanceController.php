        ...
        ${$constructible . 'Dossiers'} = ${$constructible . 'Dossiers'}
            ...
            return $item->map(function ($item, $key) use ($constructible){
               ...
               'totalSurfaceReserve'. $constructible
                            => ($item->dossier !=null && $item->dossier != null) ? $item->constructible->surface : 0 ,
               'nbrVendus'. $constructible
                            => ($item->dossier !=null && $item->dossier != null) ? 1 :0 ,       
               'CaReserve'. $constructible
                            => ($item->dossier !=null && $item->dossier != null) ? $item->totalDefinitif : 0 ,
               'totalPaiementsV'. $constructible
                            => ($item->dossier !=null && $item->dossier != null) ? $item->dossier->totalPaiementsV : 0,
               'totalPaiementsNV'. $constructible
                            => ($item->dossier !=null && $item->dossier != null) ? ($item->dossier->totalPaiements - $item->dossier->totalPaiementsV) : 0 ,
               'tauxPaiement'. $constructible
                            => ($item->dossier !=null && $item->dossier != null) ? $item->dossier->tauxPaiementV : 0 ,
               'reliquat'. $constructible
                            => ($item->dossier !=null && $item->dossier != null) ? $item->dossier->reliquat : 0 ,
               'reliquatDu30Pourcent'. $constructible
                            => ($item->dossier !=null && $item->dossier != null) ? $item->dossier->avanceNonEnc : 0 ,                            
                    ];
            });
        });
